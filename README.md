...
- [Настройка](#setup)
    - [Настройка Lightbox](#lightbox-setup)
    - [Контролы](#controls)
    - [Настройка карусели](#carousel-setup)
- [Клавиатурные сокращения](#keyboard-shortcuts)
- [Опции](#options)
    - [Опции по-умолчанию](#default-options)
    - [События обратных вызовов](#event-callbacks)
    - [Опции Карусели](#carousel-options)
    - [Опции индикатора](#indicator-options)
    - [Опции полно-экранности](#fullscreen-options)
    - Опции видео](#video-options)
...
- [API](#api)
    ...
    - [Видео](#videos)
        ...
        - [YouTube](#youtube)
        - [Vimeo](#vimeo)
    - [Дополнительные элементы Gallery](#additional-gallery-elements)
    - [Дополнительные типы контент](#additional-content-types)
        - [Example HTML text factory implementation](#example-html-text-factory-implementation)
    - [jQuery плагин](#jquery-plugin)
